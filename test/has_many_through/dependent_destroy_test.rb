...
class HasManyThroughDependentDestroyTest < ActiveSupport::TestCase
  ...
  class Image < ActiveRecord::Base
    ...
    has_many :ships, through: :image_orderings, inverse_of: :images, cached_at: true, dependent: :destroy
  end
